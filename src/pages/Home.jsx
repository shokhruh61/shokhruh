    ...
    <div className='container max-w-screen-lg mx-auto px-5'>
      <div className='flex flex-col sm:flex-row items-center'>
        ...
        <div className='mt-5 sm:mt-0 sm:ml-5 text-center sm:text-left'>
          ...
          <h3 className='text-gray-900 font-normal text-2xl '>
            Front end dasturchi
          </h3>
          <div className='flex justify-center sm:justify-start gap-3 mt-3'>
            <a  href='https://www.linkedin.com/in/shoxruh-mahmudov/'>
              <img className='w-8 h-8' src={Linkedin} alt='LinkedIn' />
            </a>
            <a  href='https://t.me/Makhmudov61'>
              <img className='w-8 h-8' src={Telegram} alt='Telegram' />
            </a>
            <a  href='https://shohruxmahmudov61@gmail.com'>
              <img className='w-8 h-8' src={Email} alt='Email' />
            </a>
            <a  href='https://github.com/shokhruh61'>
              <img className='w-8 h-8' src={GitHub} alt='GitHub' />
            </a>
            <a  href='https://docs.google.com/document/d/1RWa6mrnRYecrgffVFCd7LhWLqbq8D6Tar6bEm3X6XNI/edit?usp=sharing'>
      ...
      <div className='mt-5 sm:w-[400px] text-center sm:text-left'>
        <p className='mb-5 sm:text-lg animate-slide-top delay-600'>
          ...
          <span className='underline'>muammoni</span> atiga bir necha qator kod
          bilan <span className='underline'>hal qilishimga</span> ishonasizmi?
        </p>
        {/* Tugmalar */}
